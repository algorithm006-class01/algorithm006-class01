...
public class LeetCode_126_391 {
    ...
    public static void main(String[] args) {
        ...
        List<List<String>> list = new LeetCode_126_391().findLadders(beginWord, endWord, wordList);
        System.out.println("耗时：" + (System.currentTimeMillis() - start) + " 结果：" + list);
    }
